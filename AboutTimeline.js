const timelineData = {
  scratch: {
    ...
    descriptions: [
      ...
      "Over the course of several more undertale fangames, I stopped working in scratch for a while, until one day I decided to return. Having recentally become interested in the original doom and how it worked, I ended up finding out the technology behind it was named Raycasting, and coincidentally a tutorial for scratch to make a raycasting engine was just released a few days ago. Following this tutorial, pushing the Scratch engine to its limits, I began working on my 'Doom Inspired Game'.",
